  ...
  return (
    <Dialog>
      <DialogTrigger asChild>
        <div className="py-2 px-5 rounded-full border flex items-center cursor-pointer">
          <div className="flex h-full divide-x font-medium">
            <p className="px-4">Anywhere</p>
            <p className="px-4">Any Week</p>
            <p className="px-4">Add Guests</p>
          </div>
          <Search className="p-1 bg-primary text-white h-8 w-8 rounded-full" />
        </div>
      </DialogTrigger>
          ...
          {step === 1 ? (
            ...
            <>
              <DialogHeader>
                ...
                <DialogDescription>
                  Please Choose a options, so that what you want
                </DialogDescription>
              </DialogHeader>
